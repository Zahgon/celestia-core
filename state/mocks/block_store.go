...
func (_m *BlockStore) Close() error { _ = "STUB: not implemented"; return nil }
...
func (_m *BlockStore) LoadTxInfo(hash []byte) *store.TxInfo { _ = "STUB: not implemented"; return nil }
