...
// respectively.
func New(sampleRate, windowSize time.Duration) *Monitor { _ = "STUB: not implemented"; return nil }

// Update records the transfer of n bytes and returns n. It should be called
// after each Read/Write operation, even if n is 0.
func (m *Monitor) Update(n int) int { _ = "STUB: not implemented"; return 0 }

// Hack to set the current rEMA.
func (m *Monitor) SetREMA(rEMA float64) { _ = "STUB: not implemented"; return }
...
func (m *Monitor) Done() int64 { _ = "STUB: not implemented"; return 0 }
...
func (m *Monitor) Status() Status { _ = "STUB: not implemented"; return *new(Status) }
...
func (m *Monitor) SetTransferSize(bytes int64) { _ = "STUB: not implemented"; return }
...
func (m *Monitor) reset(sampleTime time.Duration) { _ = "STUB: not implemented"; return }
